...
void ABFilterPortReceiveLive(ABFilterPort *inputPort, AudioBufferList *bufferList, UInt32 lengthInFrames, AudioTimeStamp *outTimestamp);
...
BOOL ABFilterPortIsConnected(ABFilterPort *inputPort);
