...
__attribute__((weak)) void ABFilterPortReceiveLive(ABFilterPort *inputPort, AudioBufferList *bufferList, UInt32 lengthInFrames, AudioTimeStamp *outTimestamp) {
    printf("ABFilterPortReceiveLive stub called\n");
}
...
__attribute__((weak)) BOOL ABFilterPortIsConnected(ABFilterPort *inputPort) {
    printf("ABInputPortIsConnected stub called\n");
    return NO;
}
