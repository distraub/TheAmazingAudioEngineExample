 ...
 *  preset, for later restoration in @link loadStateFromDictionary: @endlink.
 ...
 *  @link dictionaryForCurrentState @endlink, and should apply this state
 ...
 *      @link presetDictionaryForCurrentState@ endlink. In addition to the keys
 ...
 *  create receiver, sender and/or filter ports as required, and either create and use an
 ...
 *
 * @param trigger       The trigger
 * @param showInConnectionPanel Whether the trigger should appear in the Audiobus Connection Panel. If NO,
 *                      the trigger can be accessed via specialized control apps.
 */
- (void)addTrigger:(ABTrigger*)trigger showInConnectionPanel:(BOOL)showInConnectionPanel;
 ...
 *
 * @param The port to add
 */
- (void)addSenderPort:(ABSenderPort*)port;

/*!
 * Access an sender port
 *
 ...
 *
 *  The sender ports you have registered with @link addSenderPortNamed:title: @endlink, as an
 ...
 *
 *  The receiver ports you have registered with @link addReceiverPortNamed:title: @endlink, as an
 ...
 */
@property (nonatomic, strong, readonly) NSArray *connectedPorts;
 ...
 *
 *  You should observe this property in order to manage your app's life-cycle: If your
 ...
 *
 *  See the [Background Audio](@ref Background-Audio) section of the integration guide for
